package da.delightedanimation.feature.step4.detail
...
import da.delightedanimation.databinding.ActivityStep4DetailBinding
import da.delightedanimation.feature.cat.CatItem
import da.delightedanimation.feature.step4.list.CatClickEvent

class Step4DetailActivity : AppCompatActivity() {

    companion object {
        const val CAT_EXTRA = "CAT_EXTRA"

        fun route(activity: Activity, item: CatClickEvent?) {
            val i = Intent(activity, Step4DetailActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = DataBindingUtil.setContentView<ActivityStep4DetailBinding>(this, R.layout.activity_step_4_detail)
