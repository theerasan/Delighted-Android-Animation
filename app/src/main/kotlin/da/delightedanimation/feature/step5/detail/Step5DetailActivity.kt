package da.delightedanimation.feature.step5.detail
...
import da.delightedanimation.databinding.ActivityStep5DetailBinding
import da.delightedanimation.feature.cat.CatItem
import da.delightedanimation.feature.step5.list.CatClickEvent

class Step5DetailActivity : AppCompatActivity() {

    companion object {
        const val CAT_EXTRA = "CAT_EXTRA"

        fun route(activity: Activity, item: CatClickEvent?) {
            val i = Intent(activity, Step5DetailActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = DataBindingUtil.setContentView<ActivityStep5DetailBinding>(this, R.layout.activity_step_5_detail)
